...
===================
tried-01:
Pの大きいほうからX個、Qの大きいほうからY個取得する。
そのリストの最小とRの最大を比較し、Rの最大のほうが大きければ入れ替える。

improvement:
Pの大きいほうからX個、Qの大きいほうからY個取得する。ここまでは一緒。
そのリストにRを足し、大きいほうからX+Y個取得する。
この取り方でもPとQが混ざっておかしくなることは無い。（置き換わったとしても代替可能なRからなので問題なし）
"""
